...
- Introduction of the data
  ...
  - Outcome variable: **number of registered death due to covid**
...
The aim of the analysis is to create a report on the pattern of association, choose and interpret a regression model and refer to robustness checks.
...
I chose the log transformation : ln_death = alpha + beta*ln_confirmed
